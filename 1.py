...
def print_users(users):
    ...
    csvWriter.writerow(["{0:<{nw}} {1:^6} {2:{uw}}".format(
          "Name", "ID", "Username", nw=namewidth, uw=usernamewidth)])
    csvWriter.writerow(["{0:-<{nw}} {0:-<6} {0:-<{uw}}".format(
    ...
    for key in sorted(users):
        ...
        csvWriter.writerow(["{0:.<{nw}} ({1.id:4}) {1.username:{uw}}".format(
